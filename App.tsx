        ...
        return (
          <div className="animate-in slide-in-from-right-4 fade-in duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              ...
              <div className="bg-white border-2 border-gray-100 rounded-[2.5rem] p-10 hover:border-black transition-all hover:shadow-xl lg:col-span-2">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 bg-black rounded-2xl flex items-center justify-center">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-[10px] font-mono font-black uppercase tracking-widest text-gray-400">Tool Workshop</span>
                </div>
