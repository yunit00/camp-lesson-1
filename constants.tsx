...
export const PROJECTS: ProjectExample[] = [
  ...
  { category: '🤖 Telegram-боты', title: 'Бот для приема заявок/оплаты', why: 'Автоматизация заказав и платежей.', features: ['Прием заявок', 'Обработка оплаты', 'Подтверждение заказов'] },
