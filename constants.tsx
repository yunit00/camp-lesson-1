...
export const FAQ: FAQItem[] = [
  ...
  { category: 'Результаты и проекты', question: 'Нужно ли придумывать свой проект?', answer: 'Рекомендуется выбрать реальную задачу из вашей жизни — так эффект будет максимальным. На кэмпе есть 30+ примеров проектов для вдохновения.' },
  { category: 'Результаты и проекты', question: 'Какие проекты можно создать на кэмпе?', answer: 'Боты (писатель, трекер привычек, CRM-ассистент, саммарайзер и др.), сайты (портфолио, лендинг, дашборд, блог, интернет-магазин), системы (Second Brain, базы знаний, AI-преподаватель).' },
