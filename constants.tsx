...
export const FAQ: FAQItem[] = [
  ...
  { category: 'Общие вопросы', question: 'Какой формат обучения?', answer: 'Онлайн. Смешанный формат: 4 эфира (1.5–2 часа каждый), 10+ уроков в записи, гайды и документы. Выходные дни включены для отдыха и практики.' },
